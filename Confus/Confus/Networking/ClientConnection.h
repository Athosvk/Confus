...
namespace Confus
{
	namespace Networking
	{
		...
		public:
			...
			/// <summary>
			/// Sends the orientation of the player to the server
			/// </summary>
			/// <param name="a_Orientation">The orientation of the player</param>
			void sendOrientation(const float& a_OrientationX, const float& a_OrientationY, const float& a_OrientationZ);
		private:
